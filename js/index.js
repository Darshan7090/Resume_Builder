...
$(document).ready(function(){
 ...
 previewContent += "<p>sslc: " + ssc.value + "</p>";
 previewContent += "<p>sslc board: " + sscboard.value + "</p>";
 previewContent += "<p>puc: " + hsc.value + "</p>";
 previewContent += "<p>puc board: " + hscboard.value + "</p>";
 previewContent += "<p>degree: " + degree.value + "</p>";
 previewContent += "<p>degree board: " + degreeboard.value + "</p>";
